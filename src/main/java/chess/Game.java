...
public class Game {
   ...
   public Game(Player player1, Player player2, float result) {
    ...
    */
   public static float getDeltaFromGame(Player player1, Player player2, float actualResult) {

      Integer diff = Math.round(player1.rating - player2.rating);
